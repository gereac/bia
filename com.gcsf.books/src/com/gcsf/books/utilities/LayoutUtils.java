...
public class LayoutUtils {
   ...
   */
  public static FillLayout createFillLayout(boolean horizontal,
  ...
  public static GridLayout createGridLayout(int cols, int marginWidth,
    ...
    return createGridLayout(cols, marginWidth, marginHeight, verticalSpacing,
        5, false);
  }
  ...
  public static void positionShell(Shell shell) {
    ...
    int x = Math.max(0, containerBounds.x
        + (containerBounds.width - initialSize.x) / 2);
