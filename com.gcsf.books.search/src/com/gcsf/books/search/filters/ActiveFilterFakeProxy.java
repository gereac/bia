...
public class ActiveFilterFakeProxy implements IBookDecorator,
    IStaticFilterNameProvider {

  @Override
  public String getDecoratorImagePath() {
    return StaticFiltersController.getInstance().getActiveFilter()
        .getFilterOverImagePath();
  }

  @Override
  public String getActiveFilterName() {
    return SearchActivator.getDefault().getPreferenceStore().getString(
