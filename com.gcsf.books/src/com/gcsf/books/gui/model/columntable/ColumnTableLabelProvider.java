...
public class ColumnTableLabelProvider extends LabelProvider implements
    ITableLabelProvider {
    ...
    if (columnIndex == 1) {
      if (element instanceof FolderItem) {
        ...
        if (BooksActivator.getDefault().getPreferenceStore().getBoolean(
          ...
          someImage = BooksActivator.getImageDescriptor(
              "/resource/icons/book/book.png").createImage();
          returnValue = someImage;
          ...
          if (config.length > 0) {
            ...
            DecorationOverlayIcon overlayIcon = new DecorationOverlayIcon(
                someImage, BooksActivator.getImageDescriptor(pluginContributor,
