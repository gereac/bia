 ...
 * @author bpasero
 * @param <T>
 *          The type that will be buffered
 */
public class BatchedBuffer<T> {
  ...
  /**
   * @param <T>
   *          The type that will be received from the <code>BatchedBuffer</code>
   */
  ...
  /**
   * @param receiver
   *          An instance of <code>Receiver</code> to process the elements of
   *          this buffer after <code>batchInterval</code> millies.
   * @param batchInterval
   *          The interval in millies before types get processed.
   */
   ...
   * 
   * @param objects
   *          The Collection of Objects to add into this Buffer.
   */
