 ...
 * result of the operation as an instance of <code>IStatus</code>. If the Task
 * is running from the <code>JobQueue</code> the given Priority will be used as
 * priority for the Job that runs the Task.
 * 
 * @author bpasero
 */
public interface ITask {
   ...
   *          cancellation. If the progress monitor has been canceled, the task
   *          should finish its execution at the earliest convenience and return
   *          a result status of severity IStatus.CANCEL.
