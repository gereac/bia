...
public interface ITreeNode {
  ...
  /**
   * Get the parent Node of this Node or <code>NULL</code> if no parent at all.
   * 
  ...
  /**
   * Get the first child of this Node or <code>NULL</code> if no childs at all.
   * 
   * @return Returns first child of this Node or <code>NULL</code> if no childs
   *         at all.
   */
