...
public class ExpandingReader extends Reader {
   ...
   * @param words
   *          A List of words to expand.
   * @param preValue
   *          The value to put in front of the expanded word.
   * @param postValue
   *          The value to put after the expanded word.
   * @param skipTags
   *          If <code>true</code>, do not expand when inside Tags.
   */
  public ExpandingReader(Reader in, Collection<String> words, String preValue,
      String postValue, boolean skipTags) {
    Assert.isNotNull(in);
