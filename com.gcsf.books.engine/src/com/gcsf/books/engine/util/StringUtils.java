...
public class StringUtils {
   ...
   * for searching.
   */
  // TODO add this later when the search feature will be implemented
   ...
   * 
   * @param string
   *          String to be trimmed or <code>null</code>.
   ...
   *          The String to remove the Tags from
   * @param tags
   *          the set of HTML tags to strip out of the given String or
   ...
   * 
   * @param strings
   *          The source Strings to search and replace
   * @param search
   *          The search term that should get replaced
   * @param replace
   ...
   * 
   * @param str
   *          The source String to search and replace
   * @param search
   *          The search term that should get replaced
   * @param replace
   *          The value that replaces the search term
  ...
  /**
   * @param str
   *          the string to escape for use in HTML.
