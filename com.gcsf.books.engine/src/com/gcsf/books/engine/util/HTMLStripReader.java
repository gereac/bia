...
public class HTMLStripReader extends Reader {
   ...
   * 
   * @param source
   *          The <code>Reader</code> to wrap around.
   */
  ...
  /*
   * find an end tag, but beware of comments... <script><!-- </script>
   * -->foo</script> beware markup in script strings:
   ...
   * includes that would otherwise mess up the quote handling. <a
   * href="a/<!--#echo "path"-->">
   */
