...
/**
 * Instances of <code>SearchHit</code> are the result of running a query in the
 * <code>IModelSearch</code>. Every hit provides the result identified by
 * <code>T</code>, the relevance score and allows to receive additional data in
 * a generic way.
 * 
 * @author ijuma
 * @author bpasero
 * @param <T>
 *          The type of Object this Hit provides.
 */
public class SearchHit<T> {
  ...
  /**
   * @param result
   *          a Reference to the Type that is a Hit of the Search
   * @param relevance
   *          the relevance of this Search Hit or <code>UNKNOWN_RELEVANCE</code>
   *          in case unknown.
   * @param data
   *          A Map of data that can be used from the
  ...
  /**
   * @param key
   *          The key to identify the data that is to be retrieved.
   * 
